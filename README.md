...
**Performance optimization:** I originally used the same 3D perlin on the Ink droplets shader, then later updated to just use a 2D perlin. This reduces corner samples from 8 to 4 and hash operations by ~62%, significantly improving frame rate.
